package cj.mybatis.studyproject01.util;
...
public class CJCodeGenerator {
    ...
    // 数据库连接配置
    private static final String JDBC_URL = "jdbc:mysql://172.20.1.117:3306/mybatis_study_01?useUnicode=true&useSSL=false&characterEncoding=utf8";
    private static final String JDBC_USER_NAME = "wqn";
    private static final String JDBC_PASSOWRD = "wqn641214";

    // 包名和模块名
    private static final String PACKAGE_NAME = "cj.mybatis";
    private static final String MODULE_NAME = "studyproject01";
